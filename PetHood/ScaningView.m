...
/** 扫描动画线(冲击波) */
@property (nonatomic, strong) UIView *animation_line;
...
//    _animation_line.image = [UIImage imageNamed:@"QRCodeLine"];
    self.animation_line = [[UIView alloc]init];
    self.animation_line.backgroundColor = UIColor.greenColor;
...
#pragma mark - - - 扫描边角imageView的创建
    ...
    left_imageView_down.backgroundColor = UIColor.orangeColor;
    right_imageView.backgroundColor = UIColor.orangeColor;
    right_imageView_down.backgroundColor = UIColor.orangeColor;
    left_imageView.backgroundColor = UIColor.orangeColor;
