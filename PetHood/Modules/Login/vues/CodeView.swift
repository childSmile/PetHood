    ...
    fileprivate func setUpSubview() {
        ...
        for index in 0..<codeNumber  {
            ...
            if style == .CodeStyle_line {
                ...
                layer.backgroundColor = UIColor(rgb: 0xF3F5F9).cgColor
                if index == 0 {
...
//            changeColorForLayerWithIndex(index: index, hidden: label.text!.count > 0)
        
            changeColorForLayerWithIndex(index: index, hidden:index == verStr.count ? true : false)
        }
    }
